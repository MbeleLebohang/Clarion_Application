...
include('XMLGenerator.inc'), once
   ...
   MAP
     MODULE('EMPLOYEEAPP_BC.CLW')
DctInit     PROCEDURE                                      ! Initializes the dictionary definition module
DctKill     PROCEDURE                                      ! Kills the dictionary definition module
     END
!--- Application Global and Exported Procedure Definitions --------------------------------------------
     MODULE('EMPLOYEEAPP001.CLW')
Main                   PROCEDURE   !Wizard Application for C:\Users\user\Documents\Clarion Projects\DictionaryExample\Employees.dct
     END
   END
...
Destruct               PROCEDURE
  ...
  FuzzyMatcher.SetOption(MatchOption:NoCase, 0)            ! Configure case matching
  FuzzyMatcher.SetOption(MatchOption:WordOnly, 0)          ! Configure 'word only' matching
  INIMgr.Init('.\EmployeeApp.INI', NVD_INI)                ! Configure INIManager to use INI file
  DctInit()
  Main
  INIMgr.Update
